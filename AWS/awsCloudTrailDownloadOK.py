...
if __name__ == '__main__':
    ...
    parser.add_argument('--access-key-id', required=False, default=os.environ.get('AWS_ACCESS_KEY_ID'), help='The AWS access key ID to use for authentication.')
    parser.add_argument('--secret-key', required=False, default=os.environ.get('AWS_SECRET_ACCESS_KEY'), help='The AWS secret access key to use for authentication.')
    parser.add_argument('--session-token', required=False, default=os.environ.get('AWS_SESSION_TOKEN'), help='The AWS session token to use for authentication, if there is one.')
